...
This simulation models a cold Strontium atomic source, manipulated by a combination of 
...
a linear quadrupole magnetic field, which vanishes along the y-axis. The Zeeman slower decelerates atoms along the z-axis,
