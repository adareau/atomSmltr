"""
atomSmltr ; a python package for atomic physics simulations.

Package structure
------------------

`atomsmltr.atoms`       : atomic species handling (physical properties, electronic transitions)
`atomsmltr.datapipe`    : manage data generated by the simulations (save, load..) (!) not implemented yet
`atomsmltr.environment` : all the tools to define the simulation configuration / atom environment (lasers, mag. fields, zones)
